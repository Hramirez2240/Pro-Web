#pragma checksum "C:\Users\dhima\Desktop\Pro-Web\CreativeTim.Argon.DotNetCore.Free\Views\Home\Icons.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0d70c95e8c6cf28676bcad7cfce614db6e566a94"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0d70c95e8c6cf28676bcad7cfce614db6e566a94", @"/Views/Home/Icons.cshtml")]
    ...
    public class Views_Home_Icons : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\dhima\Desktop\Pro-Web\CreativeTim.Argon.DotNetCore.Free\Views\Home\Icons.cshtml"
...
<div class=""row justify-content-center"">
    <div class=""col"">
      ...
      ");
            ...
            WriteLiteral(@"con-clipboard"" data-clipboard-text=""app"" title=""Copy to clipboard"">
                            <div>
                                <i class=""ni ni-app""></i>
                                <span>app</span>
                            </div>
        ...
        ");
            WriteLiteral(@"            <div class=""col-lg-3 col-md-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""bold-down"" title=""");
            WriteLiteral(@"Copy to clipboard"">
                            <div>
                   ...
                   ");
            WriteLiteral(@"             <span>bold-right</span>
                            </div>
                        </button>
                    </div>
                    <div class=""col-lg-3 col-md-6"">
            ...
            WriteLiteral(@"lass=""col-lg-3 col-md-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""box-2"" title=""Copy to");
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""building"" title=""Copy to clipboard"">
                            <div>
                             ...
                             ");
            WriteLiteral(@"   <span>building</span>
                            </div>
                        </button>
                    </div>
                    <div class=""col-lg-3 col-md-6"">
        ...
        ");
            WriteLiteral(@"            <div class=""col-lg-3 col-md-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-c");
            WriteLiteral(@"lipboard-text=""button-play"" title=""Copy to clipboard"">
                            <div>
            ...
            WriteLiteral(@"        </div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                ");
            WriteLiteral(@"        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""chart-pie-35"" title=""Copy to clipboard"">
                            <div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""cloud-download-95"" title=""Copy to clipboard"">
                            <div>
                                ...
                                <spa");
            WriteLiteral(@"n>cloud-download-95</span>
                            </div>
                        </button>
                    </div>
                    <div class=""col-lg-3 col-md-6"">
            ...
            WriteLiteral(@"ata-clipboard-text=""curved-next"" title=""Copy to clipboard"">
                            <div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""diamond"" title=""Copy to clipboard"">
                            <div>
                                ");
            WriteLiteral(@"<i class=""ni ni-diamond""></i>
                                <span>diamond</span>
                            </div>
                        </button>
                    </div>
            ...
            WriteLiteral(@"s=""btn-icon-clipboard"" data-clipboard-text=""favourite-28"" title=""Copy to clipboard"">
                            <div>
         ...
         ");
            WriteLiteral(@"               </button>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" clas");
            WriteLiteral(@"s=""btn-icon-clipboard"" data-clipboard-text=""circle-08"" title=""Copy to clipboard"">
                            <div>
                                <i class=""ni ni-circle-08""></i>
                                <span>circle-08</span>
                            </div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""laptop"" title=""Copy to clipboard"">
                            <div>
                                <i c");
            WriteLiteral(@"lass=""ni ni-laptop""></i>
                                <span>laptop</span>
                            </div>
                        </button>
                    </div>
            ...
            WriteLiteral(@"         </button>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button typ");
            WriteLiteral(@"e=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""money-coins"" title=""Copy to clipboard"">
                            <div>
   ...
   ");
      ...
      ");
            WriteLiteral(@"                      </div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                 ");
            WriteLiteral(@"       <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""ruler-pencil"" title=""Copy to clipboard"">
                            <div>
...
");
            ...
            WriteLiteral(@"d-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""spaceship"" title=""Copy ");
            WriteLiteral(@"to clipboard"">
                            <div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                     ...
                     ");
            WriteLiteral(@"           <span>support-16</span>
                            </div>
                        </button>
                    </div>
                    <div class=""col-lg-3 col-md-6"">
            ...
            WriteLiteral(@"       <div class=""col-lg-3 col-md-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""trophy"" tit");
            WriteLiteral(@"le=""Copy to clipboard"">
                            <div>
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""umbrella-13"" title=""Copy to clipboard"">
                            <div>
                                ...
                                <s");
            WriteLiteral(@"pan>umbrella-13</span>
                            </div>
                        </button>
                    </div>
                    <div class=""col-lg-3 col-md-6"">
            ...
            WriteLiteral(@"""col-lg-3 col-md-6"">
                    ...
                    <div class=""col-lg-3 col-md-6"">
                        <button type=""button"" class=""btn-icon-clipboard"" data-clipboard-text=""zoom-split-in"" title=""Copy to clipb");
            WriteLiteral(@"oard"">
                            <div>
