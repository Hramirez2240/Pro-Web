...
namespace GestionDeVehiculos.Data.Seeders
{
        ...
        where TIdentityRole : IdentityRole, new()
    {
        ...
        private const string DefaultAdminUserEmail = "xero@argon.com";
        ...
        {
            var user = await userManager.FindByEmailAsync("xero@argon.com");
            if (user == null)
            {
